...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(
		validator.Mathes(form.Email, validator.EmailRX),
		"email",
		"This field must be valid email address",
	)
	form.CheckField(validator.NotBlank(form.Password), "passowrd", "This field cannot be blank")
	form.CheckField(
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// ID. It's good practice to generate a new session ID when the authentication state
	// or privilege levels change for the user
	...
	// Redirect the user to the create clip page
	http.Redirect(w, r, "/clip/create", http.StatusSeeOther)
}

func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	// RenewToken() method on the current session to change the session ID again
	err := app.sessionManager.RenewToken(r.Context())
	if err != nil {
		app.serverError(w, err)
		return
	...
	// Add a flash message to the session to confirm to the user that they've been logout
